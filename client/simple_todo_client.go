...
import (
	...
	"github.com/seanrmurphy/go-vecty-swagger/client/c_o_r_s"
...
// New creates a new simple todo HTTP client.
func New(c Config) *SimpleTodo {
	var (
		host     = DefaultHost
...
// SimpleTodo is a client for simple todo
